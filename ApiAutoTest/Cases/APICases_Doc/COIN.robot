...
get/coin/details
	...
	[Tags]    Run
	${resp}    getApiResp    ${token}    get    /coin/details
...
get/coin/push
	...
	[Tags]    Run
	${params}    getParam_data    COIN    get/coin/push
	${resp}    getApiResp    ${token}    get    /coin/push    ${params}
...
get/coin/center
	...
	[Tags]    Run
	${resp}    getApiResp    ${token}    get    /coin/center
