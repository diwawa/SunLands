...
questionTypes_examQuestion
	...
	${resp}    get/questionTypes/examQuestion    ${token}    CHAPTER_PRACTICE    0    0    0    ${chapterId}
	...
	\    ${collect}    set variable if    ${resp[${x}]['questionId']}in${sql_chapter['exam_question_id']}    ${True}    ${False}
